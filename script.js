...
let arrCard = [
    ...
    { id: "10BICH", nameImg: "./PNG/10S.png", point: 37, pointType: 10 ,type:10 },
    { id: "10CHUON", nameImg: "./PNG/10C.png", point: 38, pointType: 10 ,type:10 },
    ...
    { id: "11CHUON", nameImg: "./PNG/JC.png", point: 42, pointType: 10,type:11 },
    ...
    { id: "12CHUON", nameImg: "./PNG/QC.png", point: 46, pointType: 10,type:12 },
    ...
    { id: "13CHUON", nameImg: "./PNG/KC.png", point: 50, pointType: 10,type:13 },
  ...
  function findPlayerMax(playerMax,playerX){
      ...
      if(pointPlayerMax>=10 ){
          if(pointPlayerMax==30 && playerMax.card1[0].type != 10  && playerMax.card2[0].type != 10 && playerMax.card3[0].type != 10 ){
      ...
      //xet bằng point nhau
      if(pointPlayerX==pointPlayerMax){
        if(maxCard(playerMax.card1[0].point,playerMax.card2[0].point,playerMax.card3[0].point) > maxCard(playerX.card1[0].point,playerX.card2[0].point,playerX.card3[0].point) ){
          playerMax=playerMax;
        }
        else{
          playerMax=playerX;
      ...
      //xet 3 cào
      if(playerX.card1[0].pointType+playerX.card2[0].pointType+playerX.card3[0].pointType==30 && playerX.card1[0].type != 10  && playerX.card2[0].type != 10 && playerX.card3[0].type != 10 ){

        if(playerMax.card1[0].pointType+playerMax.card2[0].pointType+playerMax.card3[0].pointType==30 && playerMax.card1[0].type != 10  && playerMax.card2[0].type != 10 && playerMax.card3[0].type != 10  ){
